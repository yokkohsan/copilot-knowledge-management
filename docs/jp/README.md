...
本運用は **特定の UI に依存せず、同じ前提と成果物を安定して再現できること**  
を目的としています。
...
### 目的
- 複数の summary / rescue から、  
  **前提知識と成果物を含む最新の正本**を作成・更新します
...
restore はあくまで再開のための前提提示に限定し、  
成果物の保存・正本化は backup / merge に委ねます。
